        ...
        children: <Widget>[
          ...
          stateAsync.when(
            ...
            data: (AiInferenceState s) => _LlmStatusRow(
              ...
              onTrigger: (AiModelInfo m) => notifier.triggerLocalDownload(m),
            ),
          ),
        ],
      ),
...
class _LlmStatusRow extends StatelessWidget {
  ...
  final void Function(AiModelInfo) onTrigger;

  @override
  Widget build(BuildContext context) {
    return switch (state) {
      AiReady(:final AiPreference mode, :final AiModelInfo activeModel) =>
      ...
      AiDownloading(:final AiModelInfo model, :final int progress) =>
